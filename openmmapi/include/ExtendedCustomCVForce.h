...
class OPENMM_EXPORT_OPENMM_LAB ExtendedCustomCVForce : public Force {
public:
    /**
     ...
     *
     * @param context    the Context containing the ExtendedCustomCVForce
 ...
 * @private
 */
class ExtendedCustomCVForce::GlobalParameterInfo {
public:
    std::string name;
    double defaultValue;
    GlobalParameterInfo() {
 ...
 * @private
 */
class ExtendedCustomCVForce::VariableInfo {
public:
    std::string name;
    Force* variable;
    VariableInfo() {
 ...
 * @private
 */
class ExtendedCustomCVForce::FunctionInfo {
public:
    std::string name;
