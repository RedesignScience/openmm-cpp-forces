...
void testCVs() {
    ...
    ExtendedCustomCVForce* cv = new ExtendedCustomCVForce("v1+3*v2");
    system.addForce(cv);
...
void testEnergyParameterDerivatives() {
    ...
    ExtendedCustomCVForce* cv = new ExtendedCustomCVForce("v1*g1+g2");
    system.addForce(cv);
...
void testTabulatedFunction() {
    ...
    ExtendedCustomCVForce* cv = new ExtendedCustomCVForce("fn(x,y)+1");
...
void testReordering() {
    ...
    System system;
    ExtendedCustomCVForce* cv = new ExtendedCustomCVForce("2*v2");
